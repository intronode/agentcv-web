...
import { listConfigurations, registerConfiguration } from '@/lib/db/queries';
...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    const result = registerConfiguration({
    ...
    console.error('POST /api/configurations failed:', error);
