...
import type { FileListItem } from '@/lib/db/types';
...
const markdownComponents: Components = {
  ...
  // The div is the scroll container; the table itself stays at natural width.
...
export function FileViewer({ files, selectedPath, content, baseUrl }: FileViewerProps) {
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0 overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4 gap-2">
            <span className="text-sm text-zinc-400 font-mono truncate min-w-0">{selectedPath}</span>
            <div className="flex items-center gap-1 border border-zinc-700 rounded overflow-hidden shrink-0">
              <button
